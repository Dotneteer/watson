...
describe("PreprocessorLexer", () => {
  ...
  it("Code: PP #3", () => {
    ...
    expect(next.location.fileIndex).toBe(0);
    expect(next.location.startPosition).toBe(0);
    expect(next.location.endPosition).toBe(source.length - 1);
    expect(next.location.startLine).toBe(1);
    expect(next.location.endLine).toBe(1);
    expect(next.location.startColumn).toBe(0);
  ...
  it("Code: PP #5", () => {
    ...
    expect(next.location.fileIndex).toBe(0);
    expect(next.location.startPosition).toBe(0);
    expect(next.location.endPosition).toBe(source.length - 3);
    expect(next.location.startLine).toBe(1);
    expect(next.location.endLine).toBe(1);
    expect(next.location.startColumn).toBe(0);
  ...
  it("Code: PP #6", () => {
    ...
    expect(next.location.fileIndex).toBe(0);
    expect(next.location.startPosition).toBe(0);
    expect(next.location.endPosition).toBe(source.length - 8);
    expect(next.location.startLine).toBe(1);
    expect(next.location.endLine).toBe(3);
    expect(next.location.startColumn).toBe(0);
